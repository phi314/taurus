            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <?php echo form_input('nama_laboratorium', set_value('nama_laboratorium'), 'class="form-control"'); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <?php echo form_input('ip_address', set_value('ip_address'), 'class="form-control"'); ?>
