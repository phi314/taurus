...
<ul class="breadcrumb">
    ...
    <li class="active">Edit <?php echo $mata_kuliah->nama_mata_kuliah; ?></li>
</ul>
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <?php echo form_input('nama_mata_kuliah', set_value('nama_mata_kuliah', $mata_kuliah->nama_mata_kuliah), 'class="form-control"'); ?>
                        <?php echo form_error('nama_mata_kuliah', '<div class="text-danger help-block">', '</div>'); ?>
                    </div>
                </div>
            </div>
            <div class="panel-footer">
                <?php echo form_hidden('id', $mata_kuliah->id); ?>
