...
<div class="row">
    ...
    <div class="col-md-3">
        <a class="tile tile-success tile-valign" href="#"><?= $jumlah_mata_kuliah; ?>
            ...
            <div class="panel-body panel-body-table">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>
                                <strong><?= $data_absensi->mengajar->mata_kuliah->nama_mata_kuliah; ?></strong>
                                <br>
                                Laboratorium <?= $data_absensi->laboratorium->nama_laboratorium; ?>
                                <br>
                                <strong><?= $data_absensi->mengajar->dosen->user->name; ?></strong>
                            </td>
