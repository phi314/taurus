            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <?php echo form_input('tanggal', set_value('tanggal', date('Y-m-d')), 'class="form-control datepicker"'); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <?php echo form_input('waktu', set_value('waktu'), 'class="form-control timepicker24"'); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            <?php echo form_input('durasi', set_value('durasi'), ['class'=>"form-control", 'placeholder'=>'Durasi dalam menit']); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <?php echo form_dropdown('laboratorium', $laboratorium_dropdown, '', 'class="form-control"'); ?>
                    ...
                    <div class="col-md-6 col-xs-12">
                        <select name="mata_kuliah" class="form-control">
                            <?php foreach($mata_kuliah as $mata_kuliah_dropdown): ?>
                                <option value="<?= $mata_kuliah_dropdown->id; ?>" <?php echo set_select('mata_kuliah', $mata_kuliah_dropdown->id); ?>><?= $mata_kuliah_dropdown->mata_kuliah->nama_mata_kuliah; ?></option>
                            <?php endforeach; ?>
                        </select>
